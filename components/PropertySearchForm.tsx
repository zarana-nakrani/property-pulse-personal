...
const PropertySearchForm = (props: Props) => {
  ...
  return (
    <form onSubmit={handleSubmit} className='mt-3 mx-auto max-w-2xl w-full flex flex-col md:flex-row items-center'>
                    <div className='w-full md:w-3/5 md:pr-2 mb-4 md:mb-0'>
                        ...
                        <input type="text" id='location' placeholder='Enter keywords or Location (City, State, Zip, etc)' 
                    ...
                    <div className='w-full md:w-2/5 md:pl-2'>
                        ...
                        <select 
                            id="property-type" className='w-full px-4 py-3 rounded-lg bg-white text-gray-800 focus:outline-none focus:ring focus:ring-blue-500 '
                            value={propertyType}
